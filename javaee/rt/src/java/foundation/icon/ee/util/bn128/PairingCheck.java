...
import static foundation.icon.ee.util.bn128.Params.B_Fp2;
import static foundation.icon.ee.util.bn128.Params.PAIRING_FINAL_EXPONENT_Z;
import static foundation.icon.ee.util.bn128.Params.TWIST;
